...
def get_document_pipeline():
  if _application_runtime is None:
    raise RuntimeError('Media router runtime is not initialized.')
  return _application_runtime.require_document_pipeline()


async def run_pipeline_task(function, *args, **kwargs):
  if _application_runtime is None:
    raise RuntimeError('Media router runtime is not initialized.')
  return await _application_runtime.run_pipeline_task(function, *args, **kwargs)
...
@media_router.post("/api/office/to-pdf")
...
@media_router.post("/api/audio/transcribe")
...
@media_router.post('/api/audio/recordings/{recording_id}/align')
...
@media_router.get('/api/audio/recordings/{recording_id}/media')
...
def create_media_router(runtime: ApplicationRuntime) -> APIRouter:
